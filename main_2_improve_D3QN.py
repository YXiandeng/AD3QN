...
from Algorithm.improve_D3QN_attention import D3QN
...
def get_args():
    ...
    parser.add_argument('--algo_name', default='improve_D3QN', type=str, help="算法名称")
    ...
    parser.add_argument('--frame_idx', default=15000, type=int, help="贪婪因子衰减率")
...
def test(cfg, env, agent):
    ...
    for i_ep in range(cfg.test_eps):
        ...
        if ma_step:
            ...
            ma_step.append(ep_step)
        print(
            f'Episode：{i_ep + 1}/{cfg.test_eps}, Reward:{ep_reward:.2f}, Step:{ep_step:.2f}, num:{numep_list[-1]:.2f}')
    print('完成测试！')
    return {'rewards': rewards, 'ma_rewards': ma_rewards, 'steps': steps, 'ma_step': ma_step, 'num': numlist}
