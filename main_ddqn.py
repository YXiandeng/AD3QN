...
# from uav_envs16_with_new_EMI import UAVEnv
...
def get_args():
    ...
    parser.add_argument('--algo_name', default='DDQN', type=str, help="算法名称")
    # parser.add_argument('--algo_name', default='double_DQN', type=str, help="算法名称")
    # parser.add_argument('--algo_name', default='dueling_DQN', type=str, help="算法名称")
    ...
    parser.add_argument('--epsilon_start', default=0.5, type=float, help="贪婪因子初始值")
...
def env_agent_config(cfg, seed=1):
    ...
    # agent = DuelingDQN(n_states,n_actions,cfg)
    if seed != 0:  # 设置随机种子
