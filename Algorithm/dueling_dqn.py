...
class DuelingDQN:
    def __init__(self, n_states, n_actions, cfg):
        ...
        self.policy_net = DuelingNet(n_states, n_actions, cfg.hidden_dim).to(self.device)
        self.target_net = DuelingNet(n_states, n_actions, cfg.hidden_dim).to(self.device)
    ...
    def save(self, path):
        torch.save(self.target_net.state_dict(), path + 'duling_dqn_checkpoint.pth')

    def load(self, path):
        self.target_net.load_state_dict(torch.load(path + 'duling_dqn_checkpoint.pth'))
